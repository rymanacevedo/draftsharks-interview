export default {
  ...
  template: `
<div class="green-grid-bg flex flex-column items-center justify-center vh-50">
    <h1 class="flex items-center justify-center mb3 f3-m f1-ns">
      <svg class="h2 mr2" enable-background="new 0 0 65 65" viewBox="0 0 65 65" xmlns="http://www.w3.org/2000/svg">
      ...
      <span class="ml3 white">{{selectedHeader}} Depth Charts</span>
    </h1>
    <a class="b f6 link dim ph3 pv2 mb4-m ml3 ml0-m black bg-light-gray pointer br2 flex items-center justify-center">
      <svg class="h1 mr2" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" xml:space="preserve">
        <path id="print-solid" fill="#A41C1F" d="M17.5,7.5V3c0-0.3-0.1-0.6-0.4-0.9l-1.8-1.8C15.1,0.1,14.8,0,14.5,0H3.8
          ...
          V15h1.9c0,0.6-0.3,0.6-0.6,0.6V10C20,8.6,18.9,7.5,17.5,7.5z M15,17.5H5v-3.8h10V17.5z M15,8.8H5V2.5h7.5v1.9c0,0.3,0.3,0.6,0.6,0.6
